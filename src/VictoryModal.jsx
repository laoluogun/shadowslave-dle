...
function VictoryModal({ speaker, speakerImage, totalGuesses, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      <div className="bg-gray-900 border border-gray-600 rounded-none shadow-2xl p-8 max-w-sm w-full mx-4 text-center flex flex-col items-center gap-4">
        <h2 className="text-3xl font-bold tracking-widest text-white uppercase">Victory!</h2>
        <img 
          src={speakerImage} 
          alt={speaker}
          className="w-28 h-28 object-cover rounded-none border border-gray-600"
        />
        <div>
        ...
        <button 
          onClick={onClose}
          className="mt-2 w-full py-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-white font-semibold transition-colors"
        >
          Close
        </button>
      </div>
