function classicHelp() {
    ...
    <div className="flex flex-col gap-1">
            ...
            <p className="text-xs">Green tiles indicate an exact match.</p>
            <p className="text-xs">Yellow tiles indicate a partial match, meaning some information within the tile matches with today's character.</p>
            <p className="text-xs">Red tiles indicate that there are no shared properties.</p>
